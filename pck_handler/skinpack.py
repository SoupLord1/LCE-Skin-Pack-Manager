...
class SkinPack:
    ...
    def shift_ids_forward(self):
        """Adds one the ids in all of the filenames in the pack"""
    ...
    def shift_ids_backwards(self):
        """Subtracts one the ids in all of the filenames in the pack"""
        asset_list = list(self.pck.GetAssets())
